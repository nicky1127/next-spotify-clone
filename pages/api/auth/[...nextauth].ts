...
export default NextAuth({
  ...
  providers: [
    SpotifyProvider({
      clientId: process.env.NEXT_PUBLIC_CILENT_ID,
  ...
  callbacks: {
    ...
    async jwt({ token, account, user }) {
      //initial sign in, account and user are only provides when logging mechanism takes place
